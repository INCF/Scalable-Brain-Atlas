...
regionNode_class.prototype.asNestedArray = function(acr2full,minViewable,nestedArray,depth) {
  ...
  var label = (this.rgb == undefined ? '' : this.acr+' : ')+(fullName ? fullName : this.acr) + (viewable ? ' <a href="javascript:void(0)" class="rgb" onclick="selectRegion(\''+this.acr.replace("'","\\'")+'\')">[view]</a>' : '');
...
regionTree_class = function(acr2parent,rgb2acr,brainRegions,acr2nn,orphanParentAcr) {
  ...
  // create hierarchy
  for (var k in acr2parent) if (acr2parent.hasOwnProperty(k)) {
