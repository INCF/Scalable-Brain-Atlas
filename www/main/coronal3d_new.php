...
$w_panel = $w_panel2d;
?>
<body style="margin: 0px; padding: 0px; background: #EEE url('../img/incfdonders_bg.png') repeat right top; color: #000; text-align: center">
<div style="background: #FFF; width: <?php echo $w_panel+34; ?>px; padding: 16px; display: inline-block; text-align: left; border: 1px solid #999">
