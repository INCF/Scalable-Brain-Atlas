...
$w_panel = $w_panel2d;
?>
<body style="margin: 0px; padding: 16px; background: #FFF; color: #000">
<div>
...
?>
<div style="position: absolute; top: 0px; left: 80%; width: 20%; text-align: right"><a id="permalink" href="javascript:void(0)" onclick="">Permalink</a></div>
</div>
<div id="view3d" class="view-panel" style="">
  <div id="view3d_svg">Loading SVG...</div>
  <div id="view3d_controls" style="position: absolute; top: 1in">
  Rotate view:<br/>
  ...
  <div style="height: 64px">
    <div id="view3d_title" style="width: 400px">
    </div>
    <div style="position: absolute; left: 410px; top: 0px">
    ...
    <div style="position: absolute; left: 410px; top: 30px">
...
?>
<!--div id="view2d" class="view-panel" style=""-->
  <div>
<?php
$bb = $config['boundingBox'];
$hScroll = $config['height2d'];
$wScroll = $hScroll/$bb[3]*$bb[2];
$wMin = $config['width2d'];
if (is_array($wMin)) list($wMin,$wMax) = $wMin;
else $wMax = $wMin;
$overflowX = false;
if ($wScroll<$wMin) $w = $wMin;
elseif ($wScroll>$wMax) { $w = $wMax; $overflowX = true; }
else $w = $wScroll;
$h = $hScroll + ($overflowX ? 20 : 20);
?>
  <div id="SBA_PLUGINS" class="plugins" style="height: <?php echo $h ?>px; width: 400px">
  </div>
  <div style="position: absolute; left: 410px; top: 0px; width: <?php echo $w+280 ?>px">
  </div>
  <div id="view2d_content" style="position: absolute; left: 410px; top: 0px; width: <?php echo $w.'px'.($overflowX ? '; overflow-x: scroll' : '') ?>">
<?php
if (isset($config['overlays'])) {
  echo '<div id="view2d_overlay" style="position: absolute; top: 0px; width: '.$wScroll.'px; height: '.$hScroll.'px; overflow: hidden">';
  echo '<img style="position: absolute" id="view2d_overlay_img" src=""/>';
  echo '</div>';
}
?>
      <div id="view2d_svg" style="position: relative; top: 0px">
      Loading SVG...
      </div>
    </div>
<?php
...
?>
    <!-- third column -->
    <div id="view2d_controls" class="regions" style="position: absolute; left: <?php echo $w+420 ?>px; top: 0px">
      <div style="height: 28px; width: 280px" class="regions-head">
        Regions in this slice
      </div>
      <div id="view2d_list" style="height: <?php echo $h-36 ?>px; width: 274px" class="regions-content">
      </div>
    </div>
  </div>
</div>
