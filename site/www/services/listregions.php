...
$rgb2acr = json_decode(file_get_contents('../templates/'.$template.'/template/rgb2acr.json'),true);
$acr2full = json_decode(file_get_contents('../templates/'.$template.'/template/acr2full.json'),true);
$acr2parent = @json_decode(file_get_contents('../templates/'.$template.'/template/acr2parent.json'),true);
$brainregions = json_decode(file_get_contents('../templates/'.$template.'/template/brainregions.json'),true);
